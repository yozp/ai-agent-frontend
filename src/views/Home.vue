  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">AI LOVE 智能体</h1>
      </div>
      <p class="subtitle">/ 让AI为你谱写浪漫 /</p>
      <div class="cyber-line"></div>
    </div>

    <!-- 浪漫装饰元素 -->
    <div class="romantic-decorations">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI 恋爱大师</div>
...
// 设置页面标题和元数据
useHead({
  title: 'AI-SIAT 智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'AI-SIAT 智能体应用平台提供AI恋爱大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
...
:root {
  ...
  --cyber-dark: #111122;
  --cyber-light: #ffffff;
  --love-gradient: linear-gradient(135deg, #ff006e, #ff4081);
}
...
.app-card:hover {
  ...
  box-shadow:
    0 15px 50px rgba(255, 0, 110, 0.25),
    inset 0 0 0 1px rgba(255, 0, 110, 0.4);
...
.circle-2 {
  ...
  bottom: -200px;
  left: -200px;
  background: radial-gradient(circle, rgba(255, 64, 129, 0.2), transparent 70%);
