        ...
        <div v-if="!msg.isUser"
          ...
          <div class="message-bubble">
            <div class="message-content" :id="`msg-${index}`">
              {{ msg.content }}
              <span v-if="connectionStatus === 'connecting' && index === messages.length - 1 && aiType === 'love'" class="typing-indicator">▋</span>
            </div>
...
.user-question {
  ...
  padding-right: 12px;
  background: linear-gradient(90deg, transparent, rgba(40, 167, 69, 0.05));
}
